...
import { HelpFullDescriptionComponent } from './help-full-description/help-full-description.component';
...
const routes: Routes = [
  ...
  {
    path: "help-full-description", component: HelpFullDescriptionComponent
  },
];
